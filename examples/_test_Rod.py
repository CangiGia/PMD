...
NOTE: MATLAB uses the Lankarani-Nikravesh model with K=1e11, e=0.95 which
      ...
      at dt=0.001 cannot accurately track.  The damped-spring model qualitatively
      replicates the bounce behaviour at a stiffness compatible with dt=0.001
      output resolution, but the post-contact trajectory diverges from MATLAB.
      This difference is documented in the validation report.
"""
