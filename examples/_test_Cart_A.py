...
pt0 = Point(body=B1, sPlocal=np.array([-0.3, -0.1]))  # B1 left  axle
pt1 = Point(body=B1, sPlocal=np.array([ 0.3, -0.1]))  # B1 right axle
pt2 = Point(body=B2, sPlocal=np.array([ 0.0,  0.0]))  # B2 center
pt3 = Point(body=B3, sPlocal=np.array([ 0.0,  0.0]))  # B3 center
