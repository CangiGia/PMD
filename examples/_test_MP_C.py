...
#%% Joints  (MATLAB J1..2 → Python j0..j1 ; indices -1)
j0 = Joint(type='rev-rev',  iPindex=0, jPindex=4, L=0.45)     # A1 <~~> Q0
...
# print(f"[_test_MP_C] Done. nB={nB}, nC={nC}, DOF={nB*3-nC}, points={len(T)}")
