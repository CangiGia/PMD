...
j1 = Joint(type='rev',  iMarker=pt_Q0, jMarker=pt_Q2)                    # Q0 <-> Q2
j2 = Joint(type='rev',  iMarker=pt_O0, jMarker=pt_O3)                    # O0 <-> O3
j3 = Joint(type='tran', iMarker=pt_B1, jMarker=pt_O3)                    # B1pt tran O3
