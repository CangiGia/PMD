...
! +++++ MODEL DECLARATION :: 
model create &
	model_name="double_compound_pendulum" &
...
model attributes model = .double_compound_pendulum size_of_icons = 20
...
entity attributes &
	entity_name     = .double_compound_pendulum.Gravity &
...
! ------------------------------------------------------- !
! ------------------------------------------------------- !
file command read file = "double_compound_pendulum_parts.cmd"
! ------------------------------------------------------- !
! ------------------------------------------------------- !
...
! ------------------------------------------------------- !
! ------------------------------------------------------- !
file command read file = "double_compound_pendulum_constraints.cmd"
! ------------------------------------------------------- !
! ------------------------------------------------------- !