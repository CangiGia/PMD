...
All dynamic analyses use **CasADi DAE collocation** (Radau IIA scheme).
Constraints are satisfied exactly at every output step — no Baumgarte
stabilisation or GGL regularisation parameters are needed.
