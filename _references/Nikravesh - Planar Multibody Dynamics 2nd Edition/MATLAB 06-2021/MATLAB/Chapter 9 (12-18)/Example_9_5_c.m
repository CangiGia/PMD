...
% Construct the joint coordinate Jacobian
    ...
    Dstar = [eye(2) s_rot(s_B1) zeros(2,3) -eye(2) -s_rot(s_B3)]
    C = Dstar*B
% Determine C_dot*theta_dot
    Dstar_d = [zeros(2) -s_B1*c_d(3) zeros(2,3) zeros(2) s_B3*c_d(9)];
    Cdtd = Dstar*Bdtd + Dstar_d*B*theta_d
...
%% Example 9.5-c
% Reaction force at the cut joint
    f_react = Dstar'*LagMult
    f_react_joint = B'*f_react    
